...
const Home = () => {
  return (
    <div className='intro'>
        ...
        <p>By providing a valid URL the app will generate a unique id for it.<br />
            ...
            Click on <a href="/new" style={{ color: '#00bbf0'}}>New</a> to create a new short URL<br />
            Click on <a href="/list" style={{ color: '#00bbf0'}}>List</a> to view the list of saved URLs<br />
